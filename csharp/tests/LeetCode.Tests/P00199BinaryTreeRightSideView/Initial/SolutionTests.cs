using LeetCode.P00199BinaryTreeRightSideView.Initial;
using Xunit;
using RootSolutionTestCases = LeetCode.Tests.P00199BinaryTreeRightSideView.SolutionTestCases;

namespace LeetCode.Tests.P00199BinaryTreeRightSideView.Initial;

public sealed class SolutionTests
{
    [Theory]
    [MemberData(nameof(RootSolutionTestCases.RightSideViewCases), MemberType = typeof(RootSolutionTestCases))]
    public void RightSideView_ReturnsVisibleValuesFromRightSide(int?[] values, int[] expected)
    {
