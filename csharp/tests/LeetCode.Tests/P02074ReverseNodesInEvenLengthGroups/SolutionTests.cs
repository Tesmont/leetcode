using LeetCode.P02074ReverseNodesInEvenLengthGroups;
using Xunit;
...
{
    [Theory]
    [MemberData(nameof(SolutionTestCases.ReverseEvenLengthGroupsCases), MemberType = typeof(SolutionTestCases))]
